...
The LaTeX setup uses the PDF viewer `sioyek`. For the inkscape integration, the python package [ inkscape-figures ](https://github.com/gillescastel/inkscape-figures) needs to be installed.
For live LaTeX rendering, [texpresso](https://github.com/let-def/texpresso) needs to be installed.
